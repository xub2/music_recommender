...
import 'package:music_recommender/constant/colors.dart';
import 'package:music_recommender/constant/strings.dart';
import 'package:music_recommender/model/music.dart';
import 'package:music_recommender/view_2/lyric_page.dart';
...
class _MusicPlayerState extends State<MusicPlayer> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xff19093C), // 배경 색상 설정
      body: SafeArea(
        child: Padding(
